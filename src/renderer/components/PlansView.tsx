...
export function PlansView() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-16 left-8 w-28 h-28 bg-gradient-to-br from-violet-500 to-indigo-600 rounded-[28px] flex items-center justify-center animate-float-slow select-none z-0 hidden lg:flex shadow-2xl" style={{ transform: 'perspective(800px) rotateX(15deg) rotateY(-20deg) rotateZ(-10deg)' }}>
      ...
      <span className="absolute top-[8%] left-[15%] text-violet-400 text-xl animate-pulse select-none hidden sm:inline">✨</span>
      <span className="absolute top-[20%] right-[30%] text-indigo-400 text-lg animate-pulse select-none hidden md:inline">⭐</span>
