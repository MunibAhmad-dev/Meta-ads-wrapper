 ...
 * upgrade prompt instead of the feature content. If premium or demo, renders children.
 */
export function PremiumGate({ feature, description, icon, children }: PremiumGateProps) {
  ...
  if (!PAYMENTS_ENABLED || isPremium || isDemoMode) return <>{children}</>
  ...
  return (
    <div className="flex flex-col h-full items-center justify-center p-8 text-center">
      ...
      <div className="flex flex-col gap-3 items-center w-full max-w-xs">
        <Button
          className="w-full gap-2 bg-gradient-to-r from-violet-600 to-indigo-600 hover:from-violet-700 hover:to-indigo-700 text-white border-none"
